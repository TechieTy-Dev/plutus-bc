    ...
    <form className={styles.formContainer}>
        <div className='flex h-full w-full flex-col items-center'>
            ...
            <option className={styles.options} value='BTC'>
              ...
              <option className={styles.options} value='BNB'>
                BNB
              </option>
              <option className={styles.options} value='SOL'>
                SOL
              </option>
              <option className={styles.options} value='AVAX'>
                AVAX
              </option>
              <option className={styles.options} value='MATIC'>
                MATIC
              </option>
              <option className={styles.options} value='DOT'>
                DOT
              </option>
              <option className={styles.options} value='FTT'>
                FTT
              </option>
              <option className={styles.options} value='LINK'>
                LINK
              </option>
              <option className={styles.options} value='ATOM'>
                ATOM
              </option>
              <option className={styles.options} value='UNI'>
                UNI
              </option>
            </select>
            <select className={styles.select}
