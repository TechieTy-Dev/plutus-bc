...
const styles = {
  ...
  searchIcon: 'text-gray-400 text-lg w-full',
  ...
  menuItem: 'cursor-pointer font-bold hover:text-green-400 duration-300',
}
  ...
  return (
    <div className={styles.container}>
      <div className={styles.leftHeader}>
        <Image src={logo} height={50} width={50} className={styles.logo} alt="Plutus Logo designed by KTDesignedCo "/>
      </div>
